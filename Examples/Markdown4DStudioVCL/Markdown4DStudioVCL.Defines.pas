unit Markdown4DStudioVCL.Defines;

// VCL-specific constants for the Markdown4D Studio demo. Values that are shared
// verbatim with the FMX build live in Markdown4DStudio.Defines; only VCL-specific
...
const
  WindowCaption = 'Markdown4D Studio';
