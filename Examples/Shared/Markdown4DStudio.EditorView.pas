unit Markdown4DStudio.EditorView;

{$SCOPEDENUMS ON}

// Framework-neutral abstraction over a form's live editor and preview controls,
// plus the buffer-swap document switch shared by the Markdown4DStudio forms. Each
...
// workspace/session glue lives next door in Markdown4DStudio.SessionSync.
