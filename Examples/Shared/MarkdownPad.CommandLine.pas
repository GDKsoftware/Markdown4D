unit MarkdownPad.CommandLine;

// Reads the document the shell asks the pad to open. When the pad is registered
...
type
  TPadCommandLine = record
    ...
    // it matches the workspace's file lookup. Empty when the pad was started
