unit MarkdownPad.CommandSet;

{$SCOPEDENUMS ON}

// Framework-neutral registration of the MarkdownPad command palette. The
...
// Registers the fixed MarkdownPad commands into Registry, wiring each to the
// matching action.
