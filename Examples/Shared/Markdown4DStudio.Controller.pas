unit Markdown4DStudio.Controller;

// Framework-agnostic orchestration for the Markdown4D Studio demo: owns the
...
begin
  // A file passed on the command line (Explorer opening a .md with the studio) is
