...
uses
  ...
  Markdown4D.Parser.InlineSegments.Tests in 'Markdown4D.Parser.InlineSegments.Tests.pas',
  Markdown4D.Layout.SourceLookup.Tests in 'Markdown4D.Layout.SourceLookup.Tests.pas',
