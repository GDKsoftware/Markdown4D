...
uses
  ...
  Markdown4D.Editor.InlineStyle in '..\Source\Layout\Markdown4D.Editor.InlineStyle.pas',
  ...
  Markdown4D.Editor.InlineStyle.Tests in 'Markdown4D.Editor.InlineStyle.Tests.pas',
