...
type
  ...
  private
    const
      BlockQuoteStartPriority = TMarkdownPriorities.BlockQuoteStart;
      AtxHeadingStartPriority = TMarkdownPriorities.AtxHeadingStart;
      FencedCodeStartPriority = TMarkdownPriorities.FencedCodeStart;
      HtmlBlockStartPriority = TMarkdownPriorities.HtmlBlockStart;
      SetextHeadingStartPriority = TMarkdownPriorities.SetextHeadingStart;
      ThematicBreakStartPriority = TMarkdownPriorities.ThematicBreakStart;
      ListItemStartPriority = TMarkdownPriorities.ListItemStart;
      IndentedCodeStartPriority = TMarkdownPriorities.IndentedCodeStart;
      BackslashInlinePriority = TMarkdownPriorities.BackslashInline;
      LineEndingInlinePriority = TMarkdownPriorities.LineEndingInline;
      EmphasisInlinePriority = TMarkdownPriorities.EmphasisInline;
      CodeSpanInlinePriority = TMarkdownPriorities.CodeSpanInline;
      AngleBracketInlinePriority = TMarkdownPriorities.AngleBracketInline;
      EntityInlinePriority = TMarkdownPriorities.EntityInline;
      LinkOpenerInlinePriority = TMarkdownPriorities.LinkOpenerInline;
      ImageOpenerInlinePriority = TMarkdownPriorities.ImageOpenerInline;
      LinkCloserInlinePriority = TMarkdownPriorities.LinkCloserInline;
      BlockQuoteTriggers = '>';
      AtxHeadingTriggers = '#';
      FencedCodeTriggers = '`~';
      HtmlBlockTriggers = '<';
